// AgenticSdlc.Infrastructure/Identity/KeycloakAdminOptions.cs
...
public sealed class KeycloakAdminOptions
{
    ...
    /// <summary>Client id used to obtain the admin access token. Defaults to the built-in
    /// <c>admin-cli</c> client which ships with every Keycloak installation.</summary>
